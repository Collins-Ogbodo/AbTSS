"""A wrapper to flatten MultiDiscrete actions in OpenAI Gym environments.
This wrapper converts a MultiDiscrete action space into a Discrete action space by flattening the actions   
into a single integer. The original MultiDiscrete action space is preserved for the environment's internal use.
